            ...
            <aside class="action-sidebar">
                ...
                <div class="contact-form-container">
                    ...
                    <div style="display: flex; gap: 10px; margin-top: 1rem; width: 100%;">
                        <a href="https://wa.me/${(car.seller?.telefono || '5491100000000').replace(/[^0-9]/g, '')}?text=Hola,%20vengo%20de%20SmartAuto.%20Estoy%20interesado%20en%20el%20${encodeURIComponent(car.brand + ' ' + car.model + ' (' + car.year + ')')}." target="_blank" style="flex: 1; display: flex; align-items: center; justify-content: center; gap: 8px; background-color: #25D366; color: white; padding: 12px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 0.9rem;">
                        ...
                        <button id="btn-download-pdf" class="btn-detail" style="flex: 1; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 12px; border-radius: 8px; font-weight: bold; font-size: 0.9rem; margin-top: 0; width: auto;">
